...
public class CurrencyPriceRepository : ICurrencyPriceRepository
{
    ...
    public CurrencyPriceRepository(IMongoClient client, IConfiguration configuration)
    {
    ...
    {
        var poeNinjaRequestUri = $"https://poe.ninja/api/data/CurrencyOverview?league={_configuration["CurrentLeague"]}&type=Currency&language=en";
